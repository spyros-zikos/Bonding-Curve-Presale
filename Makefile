...
install :; forge install openzeppelin/openzeppelin-contracts@v5.1.0 --no-commit && forge install smartcontractkit/chainlink-brownie-contracts@1.3.0 --no-commit && forge install uniswap-v3-core=Uniswap/v3-core --no-commit && forge install uniswap-v3-periphery=Uniswap/v3-periphery --no-commit && forge install permit2=Uniswap/permit2 --no-commit
